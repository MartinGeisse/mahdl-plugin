...
public class Tokenizer {
	 ...
	 * @throws IOException on I/O errors
	 */
	private String skipCharactersExceptNewline(final boolean capture) throws IOException {
		final StringBuilder captured = (capture ? new StringBuilder() : null);
	...
	public Token getToken() throws IOException {
		...
		if (lookaheadCharacter == ';') {
			...
			final String value = skipCharactersExceptNewline(true).trim();

			// create the token
			final Token token = createToken(Token.TOKEN_NEWLINE, value);
