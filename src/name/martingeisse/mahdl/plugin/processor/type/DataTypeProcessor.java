 ...
 */
public final class DataTypeProcessor {
	...
	public DataTypeProcessor(@NotNull ErrorHandler errorHandler,
	...
	private int processConstantSizeExpression(@NotNull Expression expression) {
		ConstantValue value = formallyConstantExpressionEvaluator.evaluate(expression);
