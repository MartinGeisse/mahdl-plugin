...
public class MapagGeneratedMahdlParser implements PsiParser, LightPsiParser {
	...
	private static final int ACTION_TABLE_WIDTH = 82;
	...
	static {
		try (InputStream inputStream = MapagGeneratedMahdlParser.class.getResourceAsStream("/MapagGeneratedMahdlParser.actions")) {
			try (DataInputStream dataInputStream = new DataInputStream(inputStream)) {
				ACTION_TABLE = new int[727 * ACTION_TABLE_WIDTH];
	...
	private static final Object[] ALTERNATIVE_INDEX_TO_PARSE_NODE_HEAD = {
                    ...
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_IDENTIFIER_DOT),
                    name.martingeisse.mahdl.plugin.input.Symbols.implementationItem_SignalLikeDefinition,
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.declaredSignalLike_WithoutInitializer,
                    name.martingeisse.mahdl.plugin.input.Symbols.declaredSignalLike_WithInitializer,
                    ...
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_PortDefinition),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_DeclaredSignalLike_COMMA),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_DeclaredSignalLike_COMMA),
	...
	private static final String[] STATE_INPUT_EXPECTATION = {
                    ...
                    "!= % & * + - / < << <= = == > >= >> ? [ ^ _ |",
                    "!= % & * + - / ; < << <= == > >= >> ? [ ^ _ |",
                    "(identifier) KW_CONSTANT KW_REGISTER KW_SIGNAL do",
                    "(",
                    ")",
                    "(identifier) KW_CONSTANT KW_REGISTER KW_SIGNAL do",
                    "(identifier)",
                    ...
                    ";",
                    ";",
                    "(identifier) KW_CONSTANT KW_REGISTER KW_SIGNAL do else",
                    "(identifier) KW_CONSTANT KW_REGISTER KW_SIGNAL do",
