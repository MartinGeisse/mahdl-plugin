...
public class MapagGeneratedMahdlParser implements PsiParser, LightPsiParser {
	...
	private static final int ACTION_TABLE_WIDTH = 78;
	...
	static {
		try (InputStream inputStream = MapagGeneratedMahdlParser.class.getResourceAsStream("/MapagGeneratedMahdlParser.actions")) {
			try (DataInputStream dataInputStream = new DataInputStream(inputStream)) {
				ACTION_TABLE = new int[786 * ACTION_TABLE_WIDTH];
	...
	private static final Object[] ALTERNATIVE_INDEX_TO_PARSE_NODE_HEAD = {
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_IDENTIFIER_COMMA),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_IDENTIFIER_COMMA),
                    ...
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_ImplementationItem),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_CaseItem),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_CaseItem),
                    name.martingeisse.mahdl.plugin.input.Symbols.caseItem_Value,
                    name.martingeisse.mahdl.plugin.input.Symbols.caseItem_Default,
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_Literal,
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_Signal,
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_BinaryBitwiseAnd,
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_BinaryBitwiseOr,
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_BinaryBitwiseXor,
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_Mux,
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_InterfaceItem),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_InterfaceItem),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_DeclaredSignal_COMMA),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_DeclaredSignal_COMMA),
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.dataType_Memory,
                    name.martingeisse.mahdl.plugin.input.Symbols.dataType_Integer,
                    name.martingeisse.mahdl.plugin.input.Symbols.dataType_Text,
                    name.martingeisse.mahdl.plugin.input.Symbols.qualifiedIdentifier,
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.interfaceItem,
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_IDENTIFIER_DOT),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_IDENTIFIER_DOT),
                    name.martingeisse.mahdl.plugin.input.Symbols.implementationItem_SignalDeclaration,
                    name.martingeisse.mahdl.plugin.input.Symbols.implementationItem_ModuleInstance,
                    name.martingeisse.mahdl.plugin.input.Symbols.implementationItem_DoBlock,
                    name.martingeisse.mahdl.plugin.input.Symbols.declaredSignal_WithoutInitializer,
                    name.martingeisse.mahdl.plugin.input.Symbols.declaredSignal_WithInitializer,
                    name.martingeisse.mahdl.plugin.input.Symbols.portDirection_Const,
                    name.martingeisse.mahdl.plugin.input.Symbols.portDirection_Input,
                    name.martingeisse.mahdl.plugin.input.Symbols.portDirection_Output,
                    name.martingeisse.mahdl.plugin.input.Symbols.portDirection_Inout,
                    name.martingeisse.mahdl.plugin.input.Symbols.portConnection,
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.statement_Break,
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_PortConnection),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_List_PortConnection),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_Expression_COMMA),
                    new ListNodeGenerationWrapper(name.martingeisse.mahdl.plugin.input.Symbols.synthetic_SeparatedList_Expression_COMMA),
        	};
	...
	private static final String[] STATE_INPUT_EXPECTATION = {
                    ...
                    "KW_CASE KW_DEFAULT",
                    "KW_CASE KW_DEFAULT",
                    "CLOSING_CURLY_BRACE KW_CASE KW_DEFAULT",
                    "CLOSING_CURLY_BRACE KW_CASE KW_DEFAULT",
                    "CLOSING_CURLY_BRACE KW_CASE KW_DEFAULT",
                    "CLOSING_CURLY_BRACE KW_CASE KW_DEFAULT",
                    "CLOSING_CURLY_BRACE KW_CASE KW_DEFAULT",
                    "CLOSING_CURLY_BRACE KW_CASE KW_DEFAULT",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "COLON OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_CASE KW_DEFAULT KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_CASE KW_DEFAULT KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "COLON",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_CASE KW_DEFAULT KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_CASE KW_DEFAULT KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER KW_BIT KW_DO KW_INTEGER KW_MEMORY KW_TEXT KW_VECTOR",
                    "KW_BIT KW_INTEGER KW_MEMORY KW_TEXT KW_VECTOR",
                    "IDENTIFIER",
                    "IDENTIFIER",
                    "OPENING_SQUARE_BRACKET",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_SQUARE_BRACKET OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "OPENING_SQUARE_BRACKET",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_SQUARE_BRACKET OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "IDENTIFIER",
                    ...
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "COMMA OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR SEMICOLON",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    ...
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    ...
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    ...
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "IDENTIFIER INTEGER_LITERAL OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE COLON DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_CURLY_BRACE DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_PARENTHESIS COMMA DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_PARENTHESIS DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_SQUARE_BRACKET DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "COLON DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "COMMA DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR SEMICOLON",
                    "DOT EQUALS OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "DOT OPENING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR SEMICOLON",
                    ...
                    "CLOSING_PARENTHESIS COMMA",
                    "CLOSING_PARENTHESIS COMMA",
                    "CLOSING_CURLY_BRACE COLON OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_CURLY_BRACE OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_PARENTHESIS COMMA OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_PARENTHESIS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "CLOSING_SQUARE_BRACKET OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "COLON OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "COMMA OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR SEMICOLON",
                    "EQUALS OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    "OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR SEMICOLON",
                    "IDENTIFIER",
                    "IDENTIFIER",
                    "IDENTIFIER",
                    "IDENTIFIER",
                    ...
                    "IDENTIFIER",
                    "OPENING_PARENTHESIS",
                    "CLOSING_PARENTHESIS DOT",
                    "CLOSING_PARENTHESIS DOT",
                    "SEMICOLON",
                    "IDENTIFIER KW_BIT KW_DO KW_INTEGER KW_MEMORY KW_TEXT KW_VECTOR",
                    "CLOSING_CURLY_BRACE KW_CONST KW_INOUT KW_INPUT KW_OUTPUT",
                    "IDENTIFIER",
                    "COMMA SEMICOLON",
                    "CLOSING_CURLY_BRACE KW_CONST KW_INOUT KW_INPUT KW_OUTPUT",
                    "CLOSING_CURLY_BRACE COLON OPENING_SQUARE_BRACKET OP_AND OP_CONCAT OP_DIVIDED_BY OP_EQUAL OP_GREATER_THAN OP_GREATER_THAN_OR_EQUAL OP_LESS_THAN OP_LESS_THAN_OR_EQUAL OP_MINUS OP_MUX OP_NOT_EQUAL OP_OR OP_PLUS OP_REMAINDER OP_SHIFT_LEFT OP_SHIFT_RIGHT OP_TIMES OP_XOR",
                    ...
                    "SEMICOLON",
                    "SEMICOLON",
                    "IDENTIFIER KW_BIT KW_DO KW_ELSE KW_INTEGER KW_MEMORY KW_TEXT KW_VECTOR",
                    "IDENTIFIER KW_BIT KW_DO KW_INTEGER KW_MEMORY KW_TEXT KW_VECTOR",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_CASE KW_DEFAULT KW_ELSE KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_CASE KW_DEFAULT KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_ELSE KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "CLOSING_CURLY_BRACE IDENTIFIER INTEGER_LITERAL KW_BREAK KW_IF KW_SWITCH OPENING_CURLY_BRACE OPENING_PARENTHESIS OP_MINUS OP_NOT OP_PLUS TEXT_LITERAL VECTOR_LITERAL",
                    "OPENING_PARENTHESIS",
                    "OPENING_PARENTHESIS",
                    "OPENING_PARENTHESIS",
