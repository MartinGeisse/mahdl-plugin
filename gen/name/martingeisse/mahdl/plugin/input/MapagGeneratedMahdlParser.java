...
public class MapagGeneratedMahdlParser implements PsiParser, LightPsiParser {
	...
	private static final int ACTION_TABLE_WIDTH = 84;
	...
	static {
		try (InputStream inputStream = MapagGeneratedMahdlParser.class.getResourceAsStream("/MapagGeneratedMahdlParser.actions")) {
			try (DataInputStream dataInputStream = new DataInputStream(inputStream)) {
				ACTION_TABLE = new int[809 * ACTION_TABLE_WIDTH];
	...
	private static final Object[] ALTERNATIVE_INDEX_TO_PARSE_NODE_HEAD = {
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_RangeSelectionFixed,
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_RangeSelectionUpwards,
                    name.martingeisse.mahdl.plugin.input.Symbols.expression_RangeSelectionDownwards,
