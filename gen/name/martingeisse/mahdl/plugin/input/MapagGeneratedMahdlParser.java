...
public class MapagGeneratedMahdlParser implements PsiParser, LightPsiParser {
	...
	static {
		try (InputStream inputStream = MapagGeneratedMahdlParser.class.getResourceAsStream("/MapagGeneratedMahdlParser.actions")) {
			try (DataInputStream dataInputStream = new DataInputStream(inputStream)) {
				ACTION_TABLE = new int[726 * ACTION_TABLE_WIDTH];
	...
	private static final Object[] ALTERNATIVE_INDEX_TO_PARSE_NODE_HEAD = {
                    ...
                    name.martingeisse.mahdl.plugin.input.Symbols.implementationItem_CombinatorialDoBlock,
                    name.martingeisse.mahdl.plugin.input.Symbols.implementationItem_ClockedDoBlock,
	...
	private static final String[] STATE_INPUT_EXPECTATION = {
                    ...
                    "!= % & * + - / : < << <= == > >= >> ? [ ^ _ |",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break case default if switch { } ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break case default if switch { } ~",
                    ":",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break case default if switch { } ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break case default if switch { } ~",
                    "(identifier) bit do integer memory text vector",
                    "bit integer memory text vector",
                    "(identifier)",
                    "(identifier)",
                    "[",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - ~",
                    ...
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break if switch { ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break if switch { ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break if switch { ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break if switch { ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break if switch { ~",
                    ...
                    ";",
                    ";",
                    "(identifier) bit do else integer memory text vector",
                    "(identifier) bit do integer memory text vector",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break case default else if switch { } ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break case default if switch { } ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break else if switch { } ~",
                    "( (identifier) (integer-literal) (text-literal) (vector-literal) + - break if switch { } ~",
                    "(",
                    "(",
                    "(",
